//~~tv:6026.20150825
//~~tc: Adding tag Facebook Tag


//tealium universal tag - utag.sender.6026 ut4.0.201511200551, Copyright 2015 Tealium.com Inc. All Rights Reserved.
try {
  (function (id, loader) {
    var u = {};
      ...
      if (u.ev[a] || u.ev.all !== undefined) {
        ...
        if (u.initialized) {
          ...
          if (!u.scriptrequested) {
            ...
            u.loader({"type": "script",  "src": u.data.base_url, "cb": u.callBack, "loc": "script", "id": 'utag_30'});
            //FB PreLoad Code
            !function (f, b, e) {
